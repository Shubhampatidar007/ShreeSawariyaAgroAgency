                    ...
                    {recentBills.length === 0 ? (
                      ...
                      recentBills.map((bill) => (
                        <TableRow key={bill.id}>
                          ...
                          <TableCell className="hidden md:table-cell text-muted-foreground">{bill.village}</TableCell>
                          <TableCell className="hidden sm:table-cell capitalize text-muted-foreground">{bill.paymentMethod}</TableCell>
                          ...
                          <TableCell className="text-right">
                            <Badge
                              ...
                              className={bill.paymentStatus === "pending" ? "border-destructive/40 capitalize text-destructive" : "capitalize"}
                            >
                              {bill.paymentStatus}
                            </Badge>
                          </TableCell>
            ...
            <Card className="shadow-soft">
              ...
              <CardContent className="space-y-4">
                {lowStockItems.length === 0 ? (
                  <p className="text-sm text-muted-foreground">{t("admin.overview.everythingHealthy")}</p>
                ) : (
                  lowStockItems.slice(0, 5).map((item) => (
                    <div key={item.id} className="space-y-1.5">
                      ...
                      <Progress value={item.minStockLevel ? (item.quantity / item.minStockLevel) * 100 : 0} className="h-1.5" />
                    </div>
                  ))
                )}
              </CardContent>
