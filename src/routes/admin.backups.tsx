...
async function runManualBackup(localRootHandle: any) {
  ...
  try {
    ...
    const metadata = {
      Shop: "Shree Sanwariya Agro Agency",
      "Backup type": "Manual",
