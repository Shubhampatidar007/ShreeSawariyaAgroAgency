...
export function AboutAgricultureTech() {
  return (
    <section
      id="agriculture-tech"
      className="relative overflow-hidden border-t border-white/10 bg-[#080d08] py-28 sm:py-40"
      aria-labelledby="field-tech-title"
    >
      ...
      <div className="about-scroll-content relative z-[1] mx-auto w-[min(100%-1.25rem,1200px)]">
        <div className="grid items-end gap-10 lg:grid-cols-[0.34fr_0.66fr] lg:gap-20">
          <div data-cinematic-element="copy">
        ...
        <div className="relative mt-18 overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a140b] p-5 sm:mt-24 sm:p-8" style={{ minHeight: "min(68vw, 720px)" }}>
          <div data-cinematic-element="field" className="absolute inset-[-12%] opacity-90">
          ...
          <div data-cinematic-element="scan" className="pointer-events-none absolute left-0 right-0 top-0 h-px bg-[#9ff67c]/70 shadow-[0_0_30px_rgba(142,240,106,0.55)]" aria-hidden="true" />

          <div className="relative grid min-h-[min(60vw,650px)] content-end gap-8 sm:grid-cols-[0.5fr_0.5fr] sm:items-end">
            <div data-cinematic-element="card" className="max-w-xl rounded-3xl border border-white/10 bg-[#071007]/78 p-6 backdrop-blur-md sm:p-8">
            ...
            <div data-cinematic-element="rows" className="space-y-2 sm:justify-self-end sm:w-[min(100%,360px)]">
              {rows.map((row) => (
                <div key={row} className="flex items-center gap-3 text-[0.58rem] font-semibold uppercase tracking-[0.16em] text-white/30">
                  ...
                  <div className="h-px flex-1 overflow-hidden bg-white/10">
                    <div
                      data-cinematic-element="bar"
                      className="h-full bg-[#8ef06a]/55"
                      style={{ width: `${30 + row * 7}%` }}
                    />
                  </div>
