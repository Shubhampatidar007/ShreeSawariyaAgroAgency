  ...
  return (
    <section id="offers" className="mx-auto max-w-7xl px-6 py-16">
      <SectionHeading
        ...
        title={content?.headline || "Running offers at the counter and online"}
        description={
          content?.body ||
          "Mention the code at billing or apply it at checkout. Offers cannot be combined with society slab rates."
        }
      />
      <div className="mt-8">
        {offers.length === 0 ? (
          <Card className="shadow-soft">
            <CardContent className="p-6 text-sm text-muted-foreground">
              No offers yet. Add your first promotion once your catalog is ready.
            </CardContent>
          </Card>
        ) : (
