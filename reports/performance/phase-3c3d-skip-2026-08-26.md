...
The proposed RPC could not be safely verified end-to-end against the authenticated admin application, and the attempted integration required coordinated changes across the overview route and dashboard insights. Under the performance-work rules, the optimization is skipped rather than risking existing functionality.
